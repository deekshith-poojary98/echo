...
class Lexer:
    token_patterns = {
        "KEYWORD": r'\b(fn|for|if|else|foreach|in|by|return|break|continue|while|use|mut|watch)\b',
        "RETURN_TYPE": r'->',
                                ...
                                while expr_pos < len(expr_content):
                                    ...
                                    for token_type, regex in self.compiled_patterns.items():
                                        ...
                                        if expr_match:
                                            ...
                                            parts.append(Token(token_type, token_value, line_number, start_interp + 2 + expr_pos))
