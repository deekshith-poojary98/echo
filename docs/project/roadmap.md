...
- Nominal `class` + construction (0.8.0); methods + `this` (0.8.1); `interface` (0.8.2); explicit `new { ... }` fields (0.8.3); field defaults (0.8.4)
...
Details and spellings: [Priority — 0.8.x](/project/priority). Start with `start 0.8.5`.
